...
def header_footer(canvas, doc):
    ...
    canvas.drawString(
        inch,
        height - 0.55 * inch,
        "Healthcare Knowledge Agent - SDLC Low-Level Design",
    )
...
def story_cover():
    story = [
        Spacer(1, 1.15 * inch),
        p("Healthcare Knowledge Agent", "cover_title"),
...
def build_story():
    ...
    story.append(
        p(
            "The Healthcare Knowledge Agent is a containerized internal assistant for grounded healthcare "
...
def build_pdf() -> Path:
    ...
    doc = BaseDocTemplate(
        ...
        title="Healthcare Knowledge Agent SDLC Low-Level Design",
        author="OpenAI Codex",
